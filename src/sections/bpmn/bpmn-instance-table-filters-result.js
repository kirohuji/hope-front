...
import { levels, categories } from './bpmn-instance-form';
import { getLabelFromValue } from '../../utils/map';
// ----------------------------------------------------------------------

export default function BpmnInstanceTableFiltersResult({
  filters,
  onFilters,
  //
  onResetFilters,
      ...
      <Stack flexGrow={1} spacing={1} direction="row" flexWrap="wrap" alignItems="center">
        ...
        {filters.level !== 'all' && (
          <Block label="等级:">
            <Chip
              size="small"
              label={getLabelFromValue(filters.level, levels)}
...
BpmnInstanceTableFiltersResult.propTypes = {

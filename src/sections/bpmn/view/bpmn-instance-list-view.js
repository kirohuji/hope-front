...
import BpmnInstanceForm, { categories } from 'src/sections/bpmn/bpmn-instance-form';
import {
  useTable,
  getComparator,
  emptyRows,
...
import BpmnInstanceTableRow from '../bpmn-instance-table-row';
import BpmnInstanceTableToolbar from '../bpmn-instance-table-toolbar';
import BpmnInstanceTableFiltersResult from '../bpmn-instance-table-filters-result';
// ----------------------------------------------------------------------
...
export default function BpmnInstanceListView() {
    ...
    <>
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        ...
        <Card>
          ...
          {canReset && (
            <BpmnInstanceTableFiltersResult
              filters={filters}
              onFilters={handleFilters}
              //
      ...
      <Dialog fullWidth maxWidth="md" open={openForm} onClose={handleCloseFormModal}>
        ...
        <BpmnInstanceForm onSubmitData={onSave} onCancel={handleCloseFormModal} />
      </Dialog>
    </>
  );
}

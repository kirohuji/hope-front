export default {
  ...
  'Specify more than one group as a comma separated list.':
    '在输入多个用户组时，可以通过使用逗号（,）将这些组名分开',
  'Specify more than one user as a comma separated list.':
    '在输入多个用户，可以通过使用逗号（,）将这些用户分开',
  'External task': '外部任务优先级',
  'Job execution': '作业执行优先级',
  Name: '名称',
  Value: '值',
  Headers: '头部',

...
export default function PostFilters({
  ...
  const handleFilterPostGuide = useCallback(
    (newValue) => {
  ...
  const renderPostGuide = (
    <Stack>
      ...
      <Autocomplete
        ...
        onChange={(event, newValue) => handleFilterPostGuide(newValue)}
        getOptionLabel={(option) => option.name}
        renderInput={(params) => <TextField placeholder="Select Post Guides" {...params} />}

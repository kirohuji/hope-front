...
export default function NotificationFilters({
  ...
  const handleFilterNotificationGuide = useCallback(
    (newValue) => {
  ...
  const renderNotificationGuide = (
    <Stack>
      ...
      <Autocomplete
        ...
        onChange={(event, newValue) => handleFilterNotificationGuide(newValue)}
        getOptionLabel={(option) => option.name}
        renderInput={(params) => <TextField placeholder="Select Notification Guides" {...params} />}

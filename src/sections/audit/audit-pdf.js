...
export default function AuditPDF({ audit, currentStatus }) {
  const {
    items,
    taxes,
    dueDate,
      ...
      <Page size="A4" style={styles.page}>
        <View style={[styles.gridContainer, styles.mb40]}>
          ...
          <View style={{ alignItems: 'flex-end', flexDirection: 'column' }}>
            ...
            <Text> {auditNumber} </Text>
          </View>
        </View>

        <View style={[styles.gridContainer, styles.mb40]}>
          <View style={styles.col6}>
            <Text style={[styles.subtitle2, styles.mb4]}>Audit from</Text>
            <Text style={styles.body2}>{auditFrom.name}</Text>
            <Text style={styles.body2}>{auditFrom.fullAddress}</Text>
            <Text style={styles.body2}>{auditFrom.phoneNumber}</Text>
          </View>

          <View style={styles.col6}>
            <Text style={[styles.subtitle2, styles.mb4]}>Audit to</Text>
            <Text style={styles.body2}>{auditTo.name}</Text>
            <Text style={styles.body2}>{auditTo.fullAddress}</Text>
            <Text style={styles.body2}>{auditTo.phoneNumber}</Text>
          </View>
        </View>
        ...
        <Text style={[styles.subtitle1, styles.mb8]}>Audit Details</Text>

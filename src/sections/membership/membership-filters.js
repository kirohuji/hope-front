...
export default function MembershipFilters({
  ...
  const handleFilterMembershipGuide = useCallback(
    (newValue) => {
  ...
  const renderMembershipGuide = (
    <Stack>
      ...
      <Autocomplete
        ...
        onChange={(event, newValue) => handleFilterMembershipGuide(newValue)}
        getOptionLabel={(option) => option.name}
        renderInput={(params) => <TextField placeholder="Select Membership Guides" {...params} />}

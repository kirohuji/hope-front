...
export default function MembershipEditView() {
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lg'}>
      ...
      {loading ? (
        ...
        <MembershipNewEditForm currentMembership={currentMembership} />
      )}
    </Container>
  );
}

...
export default function MembershipDetailsBookers({ onRefresh, participants }) {
...
MembershipDetailsBookers.propTypes = {
  ...
  return (
    <Stack component={Card} direction="row" spacing={2} key={participant._id} sx={{ p: 3 }}>
      ...
      <Stack spacing={2} flexGrow={1}>
        ...
        />
        <Restricted to={['MembershipListPersonSignOrDelete']}>

    ...
    return book && article && <>
        <Card sx={{ display: 'flex', p: 0, borderRadius: 0, paddingBottom: '8px' }} >
            <CardMedia
                ...
                alt=""
            />
            <Box sx={{ display: 'flex', flexDirection: 'row', padding: "0 8px", alignItems: 'center', justifyContent: 'space-between', 'width': '100%' }}>
                <Stack sx={{ 'width': '100%' }}>
                    <Stack sx={{ p: 0 }}>
                        <TinyText>
                ...
                <Stack sx={{ display: 'flex', flexDirection: 'row', p: 0, pl: 1, alignItems: 'center' }}>
                    {!isPlay.value ?
